...
import com.proyectoRopa.domain.Factura;
import com.proyectoRopa.domain.Item;
import com.proyectoRopa.domain.Usuario;
import com.proyectoRopa.domain.Venta;
import com.proyectoRopa.repository.FacturaRepository;
import com.proyectoRopa.repository.ProductoRepository;
import com.proyectoRopa.repository.UsuarioRepository;
import com.proyectoRopa.repository.VentaRepository;
...
public class ItemService {
    ...
    public void facturarDescuento50() {
        //Se debe recuperar el usuario autenticado y obtener su idUsuario
        String username = "";
        var principal = SecurityContextHolder
                .getContext()
        ...
        //Se debe registrar la factura incluyendo el usuario
        Factura factura = new Factura(usuario.getIdUsuario());
        factura = facturaRepository.save(factura);// Se debe registrar las ventas de cada producto -actualizando existencias-
        @SuppressWarnings("unchecked")
        List<Item> listaItems = (List) session.getAttribute("listaItems");
        if (listaItems != null) {
            double total = 0;
