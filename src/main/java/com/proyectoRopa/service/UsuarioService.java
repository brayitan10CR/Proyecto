...
import com.proyectoRopa.domain.Rol;
import com.proyectoRopa.domain.Usuario;
import com.proyectoRopa.repository.RolRepository;
...
public class UsuarioService {
    ...
    //se incorpora rolService porque cuando se crea un usuario, se le crea un rol, el rol user
    @Autowired
